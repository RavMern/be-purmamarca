...
export class MailerController {
    ...
    @Post('newsletter')
    async sendNewsletterMailController(@Body() newsLetterForm: NewsLetterFormDto) {
      ...
      if(newsLetterForm.subtitle.length < 5 || newsLetterForm.subtitle.length>20  ) return 'Subtitulo, debe tener entre 5 y 20 caracteres.'

      if(newsLetterForm.description.length < 5  ) return 'Descripción, debe tener mas de 5 caracteres.'
